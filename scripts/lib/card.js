/* Brewly — Reviewed: 2025-11-05 — Card component used to render product tiles. Keep image path normalization consistent with backend. */
class Card {
  parent;
  title;
  image;
  ...
  #render() {
    ...
    link.href = `/products/product/?id=${this.id}`;
